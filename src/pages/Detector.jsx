      ...
      <div className="flex">
        ...
        <aside className="w-64 h-screen bg-gray-200 text-white p-6 fixed top-20 left-0">
          <nav className="flex flex-col gap-4">
            ...
            <div className="ml-4">
              <a href="/github-pull" className="hover:bg-gray-400 p-2 rounded-md text-blue-700">● Git Pull</a>
            </div>
        ...
        <main className="ml-64 mt-20 p-6 w-full">
          ...
          <textarea value={code} onChange={(e) => setCode(e.target.value)} rows={10} cols={60} className="w-full border border-gray-300 rounded-md p-2 mt-2" />
          <button onClick={handleScan} className="mt-4 px-6 py-2 bg-blue-900 text-black rounded-md hover:bg-blue-600 focus:outline-none transition duration-200">Scan</button>
        </main>
      </div>
    </>
  );
