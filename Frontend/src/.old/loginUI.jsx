  ...
  return (
    ...
    <div className="bg-blue-950 w-screen h-screen flex flex-col items-center justify-center gap-6">
            ...
            <div className="bg-stone-50 p-8 flex flex-col items-center justify-center gap-4 rounded-md shadow-lg w-100">
                ...
                <p className="text-black text-lg font-regular">nice to have you Login</p>
                <form onSubmit={handleLogin} className='flex flex-col items-center justify-center gap-4 rounded-md w-100'>
                    <input
                      type="email"
                      value={email}
                  ...
                  <button type="submit" className="w-60 !bg-blue-950 text-white px-6 py-3 rounded-md hover:bg-blue-600 focus:outline-none">Login</button>
                </form>
                
                <button onClick={handleSignUpRedirect} className="w-60 !bg-blue-950 text-white px-6 py-3 rounded-md hover:bg-blue-600 focus:outline-none" style={{ marginTop: '10px' }}>
                  Sign Up
                </button> 
